    ...
    <div class="max-w-md w-full mx-4">
        ...
        <div class="print-area bg-white rounded-[2rem] shadow-xl overflow-hidden border border-gray-100">
            ...
            <div class="p-8 bg-white text-center flex flex-col items-center justify-center">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data={{ $tiket->kode_tiket }}" alt="QR Code" class="w-40 h-40 mb-4">
                <p class="text-[10px] text-gray-500 max-w-[200px]">Simpan E-Tiket ini dan tunjukkan QR Code kepada supir saat menaiki armada.</p>
            </div>
