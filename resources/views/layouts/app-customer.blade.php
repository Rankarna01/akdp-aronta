...
<body class="flex items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-md bg-background min-h-screen sm:min-h-[850px] sm:max-h-screen sm:rounded-[2.5rem] sm:shadow-2xl relative overflow-hidden flex flex-col app-container border-x-4 border-y-8 border-gray-900">
        ...
        <main class="flex-1 overflow-y-auto pb-20 app-container relative bg-[#f8fafc]">
            @yield('content')
        </main>

        <nav class="absolute bottom-0 w-full bg-white border-t border-gray-100 rounded-t-3xl shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] px-8 py-3 flex justify-between items-center z-50">
